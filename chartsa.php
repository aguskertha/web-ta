            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Diagram Data Petugas A</h2>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body"><iframe src="linecharta.php" width="100%" height="250"></iframe></div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><iframe src="barcharta.php" width="100%" height="250"></iframe></div>
                                    <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
